...
export default defineConfig({
  title: 'Wickra',
  description:
    'Streaming-first technical indicators with a Rust core and Python, Node, and WASM bindings — 274 indicators, install-free. Same code for backtest and live tick.',
  lang: 'en-US',
  cleanUrls: true,
  ...
  head: [
    ...
    [
      'meta',
      {
        ...
        content:
          '274 indicators with a Rust core and Python / Node / WASM bindings. Same code for backtest and live tick. Install-free.',
      },
    ],
