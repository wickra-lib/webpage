...
export default defineConfig({
  title: 'Wickra',
  description:
    'Streaming-first technical indicators with a Rust core and Python, Node, and WASM bindings — 292 indicators, install-free. Same code for backtest and live tick.',
  lang: 'en-US',
  cleanUrls: true,
  ...
  head: [
    ...
    [
      'meta',
      {
        ...
        content:
          '292 indicators with a Rust core and Python / Node / WASM bindings. Same code for backtest and live tick. Install-free.',
      },
    ],
