...
hero:
  ...
  tagline: "474 indicators with a Rust core and Python, Node, and WASM bindings. Same code for backtest and live tick. Install-free."
  image:
    src: /wickra-mark.svg
    alt: Wickra
  actions:
...
474 indicators across twenty-four families. Every one is implemented once in Rust,
