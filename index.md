...
hero:
  ...
  tagline: "279 indicators with a Rust core and Python, Node, and WASM bindings. Same code for backtest and live tick. Install-free."
  image:
    src: /wickra-mark.svg
    alt: Wickra
  actions:
...
279 indicators across sixteen families. Every one is implemented once in Rust,
